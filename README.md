...
* An AgentPay account and Service Token (see [Registering Your MCP Server on AgentPay](https://docs.agentpay.me/mcp-server-developers/platform/server-registration))
